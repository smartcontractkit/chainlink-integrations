...
require (
	...
	github.com/smartcontractkit/chainlink-framework/chains v0.0.0-20250324190027-687564fda9e5
	github.com/smartcontractkit/chainlink-framework/multinode v0.0.0-20250324190027-687564fda9e5
